...
## 5. Email Authentication Settings (Optional / Recommended for Development)

By default, Supabase sends confirmation emails for new signups. For seamless local/immediate registration without email confirmation:
